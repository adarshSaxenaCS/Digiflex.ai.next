  ...
  return (
    <div className="relative h-[600px] flex items-center justify-center text-center bg-cover bg-center">
      ...
      <div className="relative z-10 max-w-3xl text-white px-6 py-12">
        ...
        "Discover the best CRM for private schools and online education. Enhance student engagement, streamline admissions, and manage school operations efficiently."
        </p>
      ...
      <div className="absolute bottom-6 left-6 flex items-center gap-3 z-10">
              ...
              />
              <span className="text-white text-lg font-semibold">School Management CRM</span>
            </div>
    </div>
  );
}
