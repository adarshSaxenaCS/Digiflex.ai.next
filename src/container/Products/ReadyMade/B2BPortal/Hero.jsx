  ...
  return (
    <div className="relative h-[600px] flex items-center justify-center text-center bg-cover bg-center">
      ...
      <div className="relative z-10 max-w-3xl text-white px-6 py-12">
        ...
        "Create a powerful B2B marketplace platform with the best B2B portal solutions. Launch your B2B ecommerce website with advanced features and seamless transactions."
        </p>
      ...
      <div className="absolute bottom-6 left-6 flex items-center gap-3 z-10">
              ...
              />
              <span className="text-white text-lg font-semibold">B2B Portal</span>
            </div>
    </div>
  );
}
