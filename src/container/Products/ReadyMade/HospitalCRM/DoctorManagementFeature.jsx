    ...
    <WrapperContainer>
      ...
      <div className="bg-[#F9FAFB] rounded-3xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center ">
        ...
        <div className="relative w-full h-[500px] rounded-3xl overflow-hidden shadow-lg group">
          <Image
            src="https://img.freepik.com/free-vector/blue-isometric-doctor-concept-with-laptop_23-2147807642.jpg?ga=GA1.1.1704139200.1743657496&semt=ais_hybrid&w=740"
          ...
          <div className="absolute bottom-6 right-6 w-28 h-28 md:w-32 md:h-32 rounded-xl border-4 border-white overflow-hidden">
            <Image
              src="https://img.freepik.com/free-vector/man-woman-accessing-medical-website_1262-19801.jpg?ga=GA1.1.1704139200.1743657496&semt=ais_hybrid&w=740"
              alt="Extra Image"
              fill
