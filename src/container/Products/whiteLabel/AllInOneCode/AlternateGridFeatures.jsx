            ...
            {staticServices.map((service, index) => {
              ...
              return (
                <div key={service.title} className="w-full flex items-center justify-center">
                  {/* Left side image for even index */}
                  {isEven && service.image && service.link ? (
                    <div className="w-1/3 flex justify-center">
                      <a href={service.link} target="_blank" rel="noopener noreferrer">
                        <Image
                          src={service.image}
                          alt={service.title}
                          className="w-80 h-[200px] object-cover rounded-lg shadow-md hover:opacity-80 transition"
                        />
                      </a>
                    </div>
                  ) : null}
                  ...
                  {/* Right side image for odd index */}
                  {!isEven && service.image && service.link ? (
                    <div className="w-1/3 flex justify-center">
                      <a href={service.link} target="_blank" rel="noopener noreferrer">
                        <Image
