...
const Saas3 = () => {
  const caseStudies = [
    {
      image:
        "https://i.pinimg.com/736x/70/c9/80/70c980f3001190ad5f829b5018a06215.jpg",
      tag: "SAAS DEVELOPMENT",
      title: "Scalable Cloud-Based Solutions",
    },
    {
      image:
        "https://i.pinimg.com/736x/c8/22/f8/c822f8d970d9419ffbf048d49e002e3f.jpg",
      tag: "MULTI-TENANT ARCHITECTURE",
      title: "Optimized SaaS Platforms",
    },
    {
      image:
        "https://i.pinimg.com/736x/04/8b/47/048b471216515fc73c0d23cb6917864b.jpg",
    ...
    <div className="w-full bg-white py-16">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-12 flex justify-between items-center">
          <div>
            <Heading>Our SaaS Success Stories</Heading>
          </div>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/70">
                ...
                <div className="absolute bottom-4 left-4">
                  <h3 className="text-black">{study.title}</h3>
                </div>
              </div>
            </div>
          ))}
