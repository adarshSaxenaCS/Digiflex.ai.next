      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 mb-14">
          {mediaLogos.map((logo, index) => (
            <div
              key={index}
              className="w-24 h-24 sm:w-32 sm:h-32 bg-white shadow-lg rounded-full flex items-center justify-center p-4"
            >
              <Image
                src={logo.src}
                alt={logo.alt}
        ...
        <div className="text-center mb-8">
          <h1 className="text-gray-900 text-3xl sm:text-5xl font-bold leading-tight">
            ...
            <span className="text-blue-600">Digiflex.ai</span>
          </h1>
          <Paragrph>
            {" "}
            We create stunning, high-performance websites tailored to your
            business needs. Elevate your online presence with our expert
