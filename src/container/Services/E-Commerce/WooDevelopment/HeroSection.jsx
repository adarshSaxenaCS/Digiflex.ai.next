  ...
  return (
    <div className="relative h-screen flex flex-col items-center justify-center text-center pb-20">
      ...
      <div className="relative max-w-4xl mx-auto w-full text-white">
        ...
        >
          WooCommerce Development Solutions for Your Business
        </motion.h1>
        ...
        >
          Optimize, customize, and grow your WooCommerce store with DigiFlex's expert solutions.
        </motion.p>
        ...
        >
          <motion.button 
            className="bg-white text-violet-950 px-5 sm:px-6 py-3 rounded-lg font-semibold shadow-md w-full sm:w-auto text-sm sm:text-base flex items-center gap-2"
            whileHover={{ scale: 1.1, backgroundColor: "#FAFAD2", color: "#4B0082" }}
            whileTap={{ scale: 0.9 }}
          >
            Get Started 🚀
          </motion.button>
