  ...
  return (
    <div className="relative h-screen flex flex-col items-center justify-center text-center pb-20">
      ...
      <div className="relative max-w-4xl mx-auto w-full text-white">
        ...
        >
          Odoo ERP Development for Seamless Business Growth
        </motion.h1>
        ...
        >
          Empower your business with customized Odoo solutions by DigiFlex. Automate, scale, and optimize efficiently.
        </motion.p>
      ...
      <div className="relative w-full flex justify-center">
        ...
        >
          {[ 
            { number: "500+", label: "Odoo Projects Delivered" },
            { number: "300+", label: "Satisfied Clients" },
            { number: "50K+", label: "Odoo Community Members" },
