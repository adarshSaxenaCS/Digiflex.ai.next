  ...
  return (
    <div className="relative h-screen flex flex-col items-center justify-center text-center pb-20">
      ...
      <div className="relative max-w-4xl mx-auto w-full text-white">
        ...
        >
          Magento Development Solutions for Your Business
        </motion.h1>
        ...
        >
          Build, customize, and grow your Magento store with DigiFlex’s expert e-commerce solutions.
        </motion.p>
      ...
      <div className="relative w-full flex justify-center">
        ...
        >
          {[ 
            { number: "500+", label: "Magento Projects" },
            { number: "300+", label: "Satisfied Clients" },
            { number: "40K+", label: "Community Members" },
...
export default MagentoHeroSection;
