...
function Azore_hero() {
  ...
  const text = "DevOps Windows Azure Services | Digiflex.ai";
  useEffect(() => {
    ...
    <div className="relative w-full min-h-screen overflow-hidden ">
      ...
      <div className="relative flex items-center justify-center z-20 min-h-screen px-4 py-20">
        <div className="max-w-6xl mx-auto text-center transform hover:scale-105 transition-transform duration-700">
          ...
          Digiflex.ai specializes in DevOps Windows Azure solutions, enabling automation, scalability, and security to streamline development, deployment, and operations for high-quality, efficient applications.
          </p>
