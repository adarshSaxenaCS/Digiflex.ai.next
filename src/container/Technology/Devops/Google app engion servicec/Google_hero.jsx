...
function Google_hero() {
  ...
  const text = "DevOps Google App Engine Services | Digiflex.ai";
  useEffect(() => {
    ...
    <div className="relative w-full min-h-screen overflow-hidden ">
      ...
      <div className="relative flex items-center justify-center z-20 min-h-screen px-4 py-20">
        <div className="max-w-6xl mx-auto text-center transform hover:scale-105 transition-transform duration-700">
          ...
          At Digiflex.ai, we specialize in providing DevOps solutions for Google App Engine, ensuring optimized application deployment, seamless CI/CD pipelines, and efficient monitoring to enhance performance and security.
          </p>
