...
export const metadata = {
  title: 'CEM Development | Customer Experience Management Solutions',
  description: 'Expert Customer Experience Management (CEM) development services for enhancing customer engagement, personalization, and business growth.',
  keywords: 'cem development, customer experience management, cem solutions, customer engagement, personalization, business growth, customer experience',
};
      ...
      <div className="relative w-full min-h-screen overflow-hidden flex items-center justify-center text-center bg-[#1A2E6F]">
        ...
        <div className="relative z-30 max-w-3xl text-white px-8">
          ...
          <p className="text-lg mb-6">
            Customer Experience Management (CEM) Development – Enhancing Engagement, Personalization, and Business Growth.
          </p>
