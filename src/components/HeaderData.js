...
export const serviceCategories = [
  ...
  },
  {
    ...
    color: "text-[#00C8D5]",
    description:
      "AI development involves machine learning, deep learning, NLP, and computer vision.",
    features: [
      {
        icon: Cloud,
  ...
  },
  {
    ...
    description:
      "End-to-end Salesforce implementation and customization services.",
    features: [
      {
        icon: Database,
...
export const technologyCategories = [
  {
    ...
    color: "text-indigo-500",
    description:
      "Building high-performance mobile applications for iOS and Android using the latest technologies.",
    features: [
      {
        icon: Smartphone,
  ...
  },
  {
    ...
    description:
      "Modern UI solutions using React, Vue, and advanced JavaScript frameworks.",
    features: [
      {
        icon: Code,
...

  {
    ...
    color: "text-orange-500",
    description:
      "DevOps is a culture that unifies development and operations through automation, CI/CD, and monitoring for faster, reliable software delivery.",
    features: [
      {
  ...
  },
  {
    ...
    color: "text-blue-500",
    description:
      "Comprehensive Salesforce solutions to enhance business processes and customer engagement.",
    features: [
      {
        icon: Globe,
        title: "Sales Cloud",
        path: "/salesforce-sales-cloud-consulting",
      },
      {
        icon: Globe,
        title: "Marketing Cloud & Pardot",
        path: "/salesforce-marketing-cloud-pardot-consulting",
      },
      {
        icon: Globe,
        title: "Service Cloud",
        path: "/salesforce-service-cloud-consulting",
      },
      {
        icon: Globe,
        title: "Community/Experience Cloud",
        path: "/salesforce-community-experience-cloud-consulting",
      },
      { icon: Globe, title: "Force.com", path: "/force-com-development" },
      {
        icon: Globe,
        title: "Einstein Analytics & Discovery",
        path: "/einstein-analytics-discovery",
      },
      {
        icon: Globe,
        title: "Commerce Cloud",
        path: "/salesforce-commerce-cloud",
      },
      { icon: Globe, title: "Revenue Cloud/CPQ", path: "/revenue-cloud-cpq" },
      {
        icon: Globe,
        title: "Lightning Experience",
        path: "/salesforce-lightning-experience",
      },
      {
        icon: Globe,
        title: "Field Service Lightning",
        path: "/field-service-lightning",
      },
      {
        icon: Globe,
        title: "Non-Profit Cloud",
        path: "/salesforce-non-profit-cloud",
      },
      { icon: Globe, title: "AppExchange Apps", path: "/appexchange-apps" },
      {
        icon: Globe,
        title: "Financial Services Cloud",
        path: "/salesforce-financial-services-cloud",
      },
      {
        icon: Globe,
        title: "Education Cloud",
        path: "/salesforce-education-cloud",
      },
    ],
    image:
      "https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=600&q=80",
...
export const productCategories = [
  {
    ...
    features: [
      {
        icon: Smartphone,
        title: "ZILLOW CLONE REAL ESTATE",
        path: "zillow-clone-real-estate-platform",
      },
      {
        icon: Smartphone,
        title: "AIRBNB CLONE",
        path: "airbnb-clone-booking-platform",
      },
      {
        icon: Layers,
        title: "FIVERR CLONE",
        path: "fiverr-clone-freelance-marketplace",
      },
      {
        icon: Layers,
        title: "UPWORK CLONE",
        path: "upwork-clone-freelancer-platform",
      },
      {
        icon: Layers,
        title: "AMAZON CLONE",
        path: "amazon-clone-ecommerce-platform",
      },
      {
        icon: Layers,
        title: "ALIBABA CLONE",
        path: "alibaba-clone-b2b-platform",
      },
      {
        icon: Layers,
        title: "PINDUODUO CLONE",
        path: "pinduoduo-clone-social-commerce",
      },
      {
        icon: Layers,
        title: "NOON CLONE",
        path: "noon-clone-online-shopping-platform",
      },
      {
        icon: Layers,
        title: "TASKRABBIT CLONE",
        path: "taskrabbit-clone-task-management",
      },
      {
        icon: Layers,
        title: "BINANCE CLONE CRYPTO EXCHANGE",
        path: "binance-clone-crypto-exchange",
      },
      {
        icon: Layers,
        title: "PANCAKESWAP CLONE",
        path: "pancakeswap-clone-defi-platform",
      },
      {
        icon: Layers,
        title: "UNISWAP CLONE SWAP",
        path: "uniswap-clone-decentralized-exchange",
      },
      {
        icon: Layers,
        title: "LOCALCRYPTOS CLONE P2P EXCHANGE",
        path: "localcryptos-clone-p2p-exchange",
      },
      {
        icon: Layers,
        title: "OPENSEA CLONE",
        path: "opensea-clone-nft-marketplace",
      },
      {
        icon: Layers,
        title: "RARIBLE CLONE",
        path: "rarible-clone-nft-marketplace",
      },
      {
        icon: Layers,
        title: "GLOVO CLONE",
        path: "glovo-clone-on-demand-delivery",
      },
      {
        icon: Layers,
        title: "INSTACART CLONE",
        path: "instacart-clone-grocery-delivery",
      },
      {
        icon: Layers,
        title: "PAYPAL CLONE",
        path: "aypal-clone-payment-gateway",
      },
      {
        icon: Layers,
        title: "CASH APP CLONE",
        path: "cash-app-clone-mobile-payment",
      },
      {
        icon: Layers,
        title: "TWITTER CLONE MICROBLOGGING",
        path: "twitter-clone-microblogging-platform",
      },
      {
        icon: Layers,
        title: "TIKTOK CLONE",
        path: "tiktok-clone-video-sharing",
      },
      {
        icon: Layers,
        title: "FACEBOOK CLONE",
        path: "facebook-clone-social-network",
      },
      {
        icon: Layers,
        title: "NETFLIX CLONE OTT",
        path: "netflix-clone-ott-streaming",
      },
      {
        icon: Layers,
        title: "THREADS CLONE",
        path: "threads-clone-social-network",
      },
      { icon: Layers, title: "TINDER CLONE", path: "tinder-clone-dating-app" },
      {
        icon: Layers,
        title: "ONLYFANS CLONE",
        path: "onlyfans-clone-content-sharing",
      },
      {
        icon: Layers,
        title: "INDRIVER CLONE BID RIDES",
        path: "indriver-clone-ride-sharing",
      },
      {
        icon: Layers,
        title: "GOJEK CLONE",
        path: "gojek-clone-multi-service-app",
      },
      { icon: Layers, title: "UBER CLONE", path: "uber-clone-ride-hailing" },
      {
        icon: Layers,
        title: "CAREEM CLONE",
        path: "careem-clone-ride-hailing-app",
      },
      {
        icon: Layers,
        title: "UBEREATS CLONE",
        path: "ubereats-clone-food-delivery",
      },
      {
        icon: Layers,
        title: "DOORDASH CLONE",
        path: "doordash-clone-food-delivery",
      },
      {
        icon: Layers,
        title: "JUSTEAT CLONE",
        path: "justeat-clone-food-delivery",
      },
      {
        icon: Layers,
        title: "FOODPANDA CLONE",
        path: "foodpanda-clone-food-delivery",
      },
      {
        icon: Layers,
        title: "GRUBHUB CLONE",
        path: "grubhub-clone-food-delivery",
      },
    ],
...
export const industries = [
  {
    ...
    title: "Industry",
    color: "text-pink-500",
    description: "Transforming healthcare with innovative software solutions.",
    features: [
      {
        icon: Glasses,
